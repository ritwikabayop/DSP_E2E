...
-- CREATE TABLE IF NOT EXISTS prod_roles ( id UUID PRIMARY KEY DEFAULT uuid_generate_v4(), team_lead TEXT NOT NULL DEFAULT '', module TEXT NOT NULL DEFAULT '', resource_eid TEXT NOT NULL DEFAULT '', role_details TEXT NOT NULL DEFAULT '', updated_by TEXT NOT NULL DEFAULT '', updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW() );
-- ALTER TABLE prod_roles ENABLE ROW LEVEL SECURITY;
